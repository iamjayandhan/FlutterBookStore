...
import 'package:flutter_firebase/features/user_auth/presentation/widgets/background_video_widget2.dart';

enum UserType { Student, Author, Admin }
...
setState(() {
  isSigningUp = false;
    ...
    if (user != null) {
      ...
      showToast(message: "You can login now..");
    } else {
